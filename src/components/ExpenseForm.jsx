        ...
        if(amount){
          ...
          if(expense){
            ...
            editExpense({
              ...
              setAlertState(true);
              setAlert({ type: 'error', message: 'Hubo un error al actualizar la lista' })
            })
          }else{
            addExpense({
              description: inputDescription,
            ...
            .then(()=> {
              ...
              setAlertState(true);
              setAlert({ type: 'success', message: 'El gasto fue agregado correctamente.' })
            })
            .catch(()=>{
              setAlertState(true);
              setAlert({ type: 'error', message: 'No se puedo agregar tus gatos' })
            })
          }

        }else{
          setAlertState(true);
          setAlert({ type: 'error', message: 'El valor que ingresaste no es correcto.' })
        }
      }else{

        setAlertState(true);
          setAlert({ type: 'error', message: 'Por favor rellena todos los campos.' })
      }
